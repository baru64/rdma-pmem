...
benchmark_labels = [
    "Zapisy metodą ARRM (librpma)",
    "Zapisy metodą GPRRM (librpma)",
    "Zapisy metodą ARRM",
    "Zapisy metodą GPRRM",
    ...
    for memsize in memsizes:
        ...
        for benchmark in benchmark_names:
            ...
            if field in ("latency", "jitter"):
                ...
                benchmarks[benchmark].append(results[benchmark][threads].get(field)*8.58993)
            else:
...
p1, = ax.plot(x, y1, "p:", color="c", label="RPMA-APM")
p2, = ax.plot(x, y2, "v--", color="m", label="RPMA-GPSPM")
p3, = ax.plot(x, y3, "*:", color="y", label="WR")
p4, = ax.plot(x, y4, "^--", color="r", label="WS")
p5, = ax.plot(x, y5, "x--",color="g", label="WI")
#ax.plot(x, y6, color="b", label="R")
p6, = ax.plot(x, y7, ".-.", color="orange", label="W")
ax.set_xlabel("Rozmiar zapisów (bajty)")
ax.set_ylabel("Opóźnienie (µs)")
ax.set_xticks(x)
ax.set_xticklabels(results["bs"][:-2])
#ax.legend()
fig.savefig("diagrams/rpma_cmp_lat_1.pdf", bbox_inches='tight')
# legend
lfig = plt.figure(figsize=(4,2))
lfig.legend([p1, p2, p3, p4, p5, p6], benchmark_labels, 'center')
lfig.savefig("diagrams/rpma_legend.pdf", bbox_inches='tight')
...
ax.set_xticklabels(results["bs"][:-2])
#ax.legend()
fig.savefig("diagrams/rpma_cmp_lat_2.pdf", bbox_inches='tight')
...
ax.set_xticklabels(results["bs"][:-2])
#ax.legend()
fig.savefig("diagrams/rpma_cmp_lat_4.pdf", bbox_inches='tight')
...
ax.set_xticklabels(results["bs"][:-2])
#ax.legend()
fig.savefig("diagrams/rpma_cmp_lat_8.pdf", bbox_inches='tight')
...
ax.set_xticklabels(results["bs"][:-2])
#ax.legend()
fig.savefig("diagrams/rpma_cmp_bw_1.pdf", bbox_inches='tight')
...
ax.set_xticklabels(results["bs"][:-2])
#ax.legend()
fig.savefig("diagrams/rpma_cmp_bw_2.pdf", bbox_inches='tight')
...
ax.set_xticklabels(results["bs"][:-2])
#ax.legend()
fig.savefig("diagrams/rpma_cmp_bw_4.pdf", bbox_inches='tight')
...
ax.set_xticklabels(results["bs"][:-2])
#ax.legend()
fig.savefig("diagrams/rpma_cmp_bw_8.pdf", bbox_inches='tight')
